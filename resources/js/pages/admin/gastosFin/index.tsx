...
const titlePage = 'Gastos Financieros';
const urlPage = '/gastosfin';

const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Gastos Financieros', href: '/gastosfin' },
];
...
export default function GastosFin() {
  ...
  const [editItem, setEditItem] = useState<GastoFin | null>(null);
  ...
  const openEditModal = (item: GastoFin) => {
    setEditItem(item);
