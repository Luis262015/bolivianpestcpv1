...
export default function Crear() {
  const { certificado, empresas } = usePage<PageProps>().props;

  const { data, setData, put, processing, errors } =
    useForm<CertificadoFormData>({
      qrcode: certificado.qrcode,
      firmadigital: certificado.firmadigital,
      ...
      condicion: certificado.condicion,
      trabajo: certificado.trabajo,
      plaguicidas: certificado.plaguicidas,
      registro: certificado.registro,
      area: certificado.area,
      acciones: certificado.acciones,
      empresa_id: String(certificado.empresa_id),
    });
  ...
  const handleSumit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    put(`/certificados/${certificado.id}`, dataToSend);
  };
