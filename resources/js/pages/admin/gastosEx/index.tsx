...
const titlePage = 'Gastos Extra';
const urlPage = '/gastosex';

const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Gastos Extras', href: '/gastosex' },
];
...
export default function GastosFin() {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Gastos Extras" />

      <div className="m-4">
        {/* Botones principales */}
        <div className="mb-4 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
          <h1 className="me-5 text-2xl font-bold">Gestión de Gastos Extras</h1>
