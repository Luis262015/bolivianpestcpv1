...
import ProveedorCreateDialog from '../proveedores/ProveedorCreateModal';
...
export default function Compra({ proveedores: proveedoresIniciales }: Props) {
  ...
  // Estado dinámico de proveedores (se actualiza al crear uno nuevo)
  ...
  const handleProveedorCreado = (nuevo: { value: number; label: string }) => {
    // Actualizamos la lista completa
    setProveedores((prev) => [...prev, nuevo]);
    // Seleccionamos automáticamente el nuevo
    setProveedorId(String(nuevo.value));
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post('/compras', payload, {
      onSuccess: () => alert('Compra guardada exitosamente'),
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="mx-auto max-w-6xl p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* === Resto del formulario (producto, tabla, totales, etc.) === */}
          {/* ... (todo igual que antes) ... */}
          {/* (puedes copiar la parte de búsqueda, tabla, totales del código anterior) */}
...
// // NUEVA interfaz para el formulario del modal
...
//   // === VERSIÓN CORRECTA (copia y pega) ===
//   const flash = usePage().props.flash as
//     | {
//         proveedores?: Proveedor[];
//         proveedor_nuevo_id?: number;
//         success?: string;
//       }
//     | undefined;

//   // Este useEffect ahora SÍ se ejecuta cuando llega el nuevo flash
//   useEffect(() => {
//     if (flash?.proveedores) {
//       setProveedores(flash.proveedores);
//       console.log('Proveedores actualizados:', flash.proveedores);
//     }

//     if (flash?.proveedor_nuevo_id) {
//       setProveedorId(flash.proveedor_nuevo_id);
//       setModalOpen(false); // ← ¡Ahora sí se cierra!
//       console.log('Proveedor creado y seleccionado:', flash.proveedor_nuevo_id);
//     }

//     if (flash?.success) {
//       // Aquí puedes usar un toast real (sonner, react-hot-toast, etc.)
//       alert(flash.success); // temporal
//     }
//   }, [flash?.proveedores, flash?.proveedor_nuevo_id, flash?.success]); // ← Dependencias individuales = React detecta el cambio
...
//                 onChange={(e) =>
//                   setProveedorId(parseInt(e.target.value) || null)
//                 }
//                 value={proveedorId || ''}
//               >
...
//               {/* Botón que abre el modal separado */}
//               <Button
//                 type="button"
//                 variant="outline"
//                 onClick={() => setModalOpen(true)}
