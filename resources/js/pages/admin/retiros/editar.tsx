...
export default function Edit({ retiro }: { retiro: Retiro }) {
  ...
  const handleSumit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    put(`/retiros/${retiro.id}`);
  };

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Retiros | Edit" />
        ...
        <form onSubmit={handleSumit} method="post" className="space-y-4">
          ...
          <div className="gap-1.5">
            ...
            >
              ...
              {/* Genera las opciones desde una fuente de datos */}
              {TiposEnum.map((tipo) => (
              ...
              <option value="Predispuesto">Predispuesto</option>
