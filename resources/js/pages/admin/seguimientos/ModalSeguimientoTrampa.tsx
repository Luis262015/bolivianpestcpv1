...
export default function ModalSeguimientoTrampa({
  ...
  const normalizeData = (data: any): FormData => ({
    trampa_especies_seguimientos: (data.trampa_especies_seguimientos ?? []).map(
      (i: any) => ({
        trampa_id: Number(i.trampa_id),
        especie_id: Number(i.especie_id),
        cantidad: Number(i.cantidad),
      }),
    ),
    trampa_roedores_seguimientos: (data.trampa_roedores_seguimientos ?? []).map(
      (r: any) => ({
        trampa_id: Number(r.trampa_id),
...
//         const normalizeRoedores = (data: any[]) =>
//           data.map((r) => ({
//             ...r,
//             trampa_id: Number(r.trampa_id),
//             cantidad: Number(r.cantidad),
...
//         const normalizeInsectos = (data: any[]) =>
//           data.map((i) => ({
//             ...i,
//             trampa_id: Number(i.trampa_id),
//             especie_id: Number(i.especie_id),
...
//         if (hasDbData) {
//           setData({
//             trampa_especies_seguimientos: normalizeInsectos(
//               dbData.trampa_especies_seguimientos ?? [],
//             ),
//             trampa_roedores_seguimientos: normalizeRoedores(
