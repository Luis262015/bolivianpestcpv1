...
export default function Lista({
  ...
  //   );
  // };
  // 2. En buscar(), asegúrate de no enviar strings vacíos
  // const buscar = () => {
  //   router.get(
  //     '/informes',
  //     {
  ...
  //     const key = row.mapa; // si los títulos son únicos
  //     // o mejor usa mapa_id si lo tienes disponible
  ...
  //     acc[key].data.push({
  //       fecha: row.seguimiento.toString(),
  //       merma_porcentaje: Number(porcentajeMerma.toFixed(2)),
  //     });
  ...
  //     acc[key].data.push({
  //       fecha: new Date(row.fecha).toLocaleDateString('es-ES'), // ← fecha formateada
  //       merma_porcentaje: Number(porcentajeMerma.toFixed(2)),
  //     });
