...
class InformesController extends Controller
{
    ...
    public function storeWord(Request $request)
    {
        ...
        $this->addSectionTitle($section, 'Lo que se realizo en la visita');

        $this->addSectionTitle($section, '1) Desratizacion');
        ...
        if ($seguimientos->contains('tipo_seguimiento_id', 3)) {
            $this->addSectionTitle($section, '3) Barreras fisicas de exclusion (Insectocutores)');
    ...
    {
        $this->addSectionTitle($section, 'Recomendaciones para la proxima visita');
    ...
    private function agregaIntroObjMetodo($section, string $empresaNombre, string $almacenNombre, string $periodoTexto): void
    {
        ...
        $this->addSectionTitle($section, 'Introduccion');
